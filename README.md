...
To update the database use this command from the Web project folder (replace `test_project_agents` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../test_project_agents.Infrastructure/test_project_agents.Infrastructure.csproj -s test_project_agents.Web.csproj
```
