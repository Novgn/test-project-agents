...
To update the database use this command from the Web project folder (replace `TestProject` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../TestProject.Infrastructure/TestProject.Infrastructure.csproj -s TestProject.Web.csproj
```
